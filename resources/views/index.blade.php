    ...
    <div class="bg-top-center">
        <div class="video-wrapper">
            <div class="video-item" data-bg-src="{{ url('assets/img/bg/video_bg_1.jpg')}}">
                <div class="video-box1"> <img src="{{ url('assets/img/bg/video_bg_1.jpg')}}" alt="video"> <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn popup-video"><i class="fa-sharp fa-solid fa-play"></i></a> </div>
            </div>
            <div class="video-item video-item-2" data-bg-src="{{ url('assets/img/bg/contact_bg_1.jpg')}}">
                <div class="row align-items-center">
                    <div class="col-xxl-8 col-xl-12">
                        <div class="title-area"> <span class="sub-title"><img src="{{ url('assets/img/shape/title_right.svg')}}" alt="shape">Achivements</span>
