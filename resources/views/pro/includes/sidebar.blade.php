                    ...
                    <ul class="metismenu left-sidenav-menu" id="side-nav">
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('app-chat-pro') }}"><span>Chat</span></a></li>
                                <li><a href="{{ url('app-calendar-pro') }}"><span>Calendar</span></a></li> 
                                ...
                                <li><a href="{{ url('app-contact-list-pro') }}"><span>Contact List</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                            <li><a href="{{ url('ui-other-clipboard-pro') }}">Clip Board</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li><a href="{{ url('advanced-sweetalerts-pro') }}">Sweet Alerts</a></li>
                                <li><a href="{{ url('advanced-ratings-pro') }}">Ratings</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('forms-advanced-pro') }}">Advance Elements</a></li>
                                <li><a href="{{ url('forms-wizard-pro') }}">Wizard</a></li>
                                <li><a href="{{ url('forms-editors-pro') }}">Editors</a></li>
                                <li><a href="{{ url('forms-repeater-pro') }}">Repeater</a></li>
                                <li><a href="{{ url('forms-uploads-pro') }}">File Upload</a></li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('charts-apex-pro') }}">Apex</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('tables-datatable-pro') }}">Datatables</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('auth-login-pro') }}">Login</a></li>
                                <li><a href="{{ url('auth-register-pro') }}">Register</a></li>
                                <li><a href="{{ url('auth-recoverpw-pro') }}">Recover Password</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{  url('page-invoice-pro') }}">Invoice</a></li>
                                <li><a href="{{ url('page-profile-pro') }}">Profile</a></li>
                                <li><a href="{{ url('page-pricing-pro') }}">Pricing</a></li>
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                <li><a href="{{ url('email-templates-alert-pro')  }}">Alert Email</a></li>
                            </ul>
                        </li>
