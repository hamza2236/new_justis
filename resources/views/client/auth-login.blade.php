...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Justiscall - client login</title>
                ...
                <div class="card mb-0 shadow-none">
                    <div class="card-body">
                        ...
                        <div class="m-3 text-center bg-light p-3 text-primary">
                            ...
                            <a href="{{  url('auth-register-client') }}" class="btn btn-primary btn-round waves-effect waves-light">Sign Up</a>                
                        </div>                        
                    </div>
                </div>
            </div>
            <div class="col-lg-6 p-0 d-flex justify-content-center">
                <div class="accountbg d-flex align-items-center"> 
                    <div class="account-title text-white text-center">
                        ...
                        <p class="font-14 mt-3">Don't have an account ? <a href="{{  url('auth-register-client') }}" class="text-primary">Sign up</a></p>
