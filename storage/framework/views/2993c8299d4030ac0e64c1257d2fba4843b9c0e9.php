<meta charset="utf-8">
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('assets/img/favicons/favicon-16x16.png')); ?>"> <!-- <link rel="manifest" href="assets/img/favicons/manifest.json"> -->
    ...
    <!--============================== All CSS File============================== -->
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/bootstrap.min.css')); ?>"> <!-- Fontawesome Icon -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/fontawesome.min.css')); ?>"> <!-- Magnific Popup -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/magnific-popup.min.css')); ?>"> <!-- Slick Slider -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/slick.min.css')); ?>"> <!-- Flip Slider -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/jquery.flipster.min.css')); ?>"> <!-- Theme Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>"><?php /**PATH /home/justiscalluk/public_html/resources/views/layouts/links-css.blade.php ENDPATH**/ ?>